...
- Suite completa desde la raíz: `node --test tests/*.test.cjs` (42 archivos, 94 pruebas). `tests/i18n-audit.cjs` y `tests/uiHarness.cjs` no son suites: son módulos auxiliares de los que dependen otras pruebas.
