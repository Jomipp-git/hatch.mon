...
const runtimeFiles=['index.html','appBootstrap.mjs','authService.mjs','cloudSaveService.mjs','appEnvironment.js','pokemonDataAdapter.js','socialEngine.js','vitalSimulation.js','relationship.js','pokedex.js','shiny.js','shellSkins.js','pokemonRenderer.js','pmdRenderer.js','trainingActivities.js','styleTracing.js'];
